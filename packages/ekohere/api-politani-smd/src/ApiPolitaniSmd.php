...
class ApiPolitaniSmd extends Britech
{
    /**
     ...
     */
    public function url($method, $url,$body=[])
    {
        return $this->httpClient($method, $url,$body, true);
    }

    /**
     * Data Mahasiswa dari Email dan Password
     *
     * @param
     */
    public function mahasiswa($email,$password)
    {
        return $this->httpClient('POST', '/mahasiswa',
            [
                'email'=>$email,
                'password'=>$password
            ]
    ...
    /**
     * Mata Kuliah yang diambil berdasarkan user id mahasiswa
     *
     * @param String    $user_id
     */
    public function getMataKuliah($user_id)
    {
        return $this->httpClient('GET', '/penduduk?user_id='.$user_id);
    }
